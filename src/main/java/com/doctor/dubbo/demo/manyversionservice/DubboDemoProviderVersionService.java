 ...
 */
public class DubboDemoProviderVersionService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        protocolConfig.setExtension("com.alibaba.dubbo.rpc.protocol.resteasy.support.VersionRequestFilter");
        ...
        demoServiceConfig1.setVersion("1.0");
